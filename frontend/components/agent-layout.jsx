...
import { CreditCard, LogOut, Plane, Settings, Ticket, Wallet } from "lucide-react";
					...
					<SidebarContent>
						<SidebarGroup>
							...
							<SidebarGroupContent>
								<SidebarMenu>
									<SidebarMenuItem>
										<SidebarMenuButton asChild data-active={pathname?.startsWith("/agent-panel/book")}
										>
						...
						<div className="p-2 text-sm space-y-2">
							<div className="flex items-center gap-2">
								...
								<div className="flex-1">
									...
									<div className="font-medium">₹ {Number(profile?.balance || 0).toLocaleString()}</div>
								</div>
							</div>
							<div className="flex items-center gap-2">
								<CreditCard className="size-4" />
